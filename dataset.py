...
class XRayDataset(Dataset):
    ...
    def __init__(self, pngs, jsons, args ,CLASSES, is_train=True, transforms=None,):
...
class XRayInferenceDataset(Dataset):
    ...
    def __init__(self, test_pngs, IMAGE_ROOT, transforms=None, ):
